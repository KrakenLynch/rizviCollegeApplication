...
public class About_us extends AppCompatActivity {
    ...
    List<Models.AboutUsModel> AboutUsModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // vision and mission
        AboutUsModel.add(new AboutUsModel("Vision and Mission", "", "VISION\n" +
        ...
        //Director
        AboutUsModel.add(new AboutUsModel("Director,s message", "Adv. Rubina Akhtar Hasan Rizvi", "Adhering strictly to our motto, ‘Equalise, Humanise and spiritualize’ and following the words of guidance of our chief patron Dr. A. H. Rizvi, we strive to create citizens who are able to face challenges of the contemporary world. We impart education that is value and skill based to enable students to accomplish their dreams and aspirations. Our stellar accomplishments expand the frontiers of knowledge. In this era of Globalization of education the obvious focus is on the quality of education. As an educational institution we continuously strive for sustenance and enhancement of quality in every field of its activity.\n" +
                "\n" +
        ...
        //Press
        AboutUsModel.add(new AboutUsModel("Press Release", "", "", R.drawable.press));

        RecyclerView myrv = (RecyclerView) findViewById(R.id.about_recyclerview);
        RecyclerViewAdapter myAdapter = new RecyclerViewAdapter(this, AboutUsModel);
